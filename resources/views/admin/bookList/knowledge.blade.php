<div class="bookViewList">
    <div class="head">
        ...
        <form action="" method="get">
            <div class="findBook">
                <input placeholder="ស្វែងរកសៀវភៅ" type="text" id="findBook2" name="findBook2">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('findBook2').addEventListener('input', function() {
            let filter = this.value.toLowerCase();
            let rows = document.querySelectorAll('#bookList2 tr');
