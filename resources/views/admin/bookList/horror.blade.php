<div class="bookViewList">
    <div class="head">
        ...
        <form action="" method="get">
            <div class="findBook">
                <input placeholder="ស្វែងរកសៀវភៅ" type="text" id="findBook1" name="findBook1">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('findBook1').addEventListener('input', function() {
            let filter = this.value.toLowerCase();
            let rows = document.querySelectorAll('#bookList1 tr');
