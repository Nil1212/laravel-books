<div class="bookViewList">
    <div class="head">
        ...
        <form action="" method="get">
            <div class="findBook">
                <input placeholder="ស្វែងរកសៀវភៅ" type="text" id="findBook5" name="findBook5">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('findBook5').addEventListener('input', function() {
            let filter = this.value.toLowerCase();
            let rows = document.querySelectorAll('#bookList5 tr');
