...
<body>
    ...
    <div class="container">
        {{-- !------------------------NewBook-Content------------------------------ --}}
        <div class="newBook">
            <h2 data-aos="fade-right" data-aos-duration="500">លទ្ធផល "{{ $query }}"</h2>
            <div class="bookList">
                @if ($books->isEmpty())
                    <p>No books found.</p>
                @else
                    <ul data-aos="fade-up" data-aos-duration="500" id="bookList">
                        ...
                        @foreach ($books->take(10) as $index => $book)
                            <li class="book-item">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                let currentPage = 1;
                let booksAll = @json($books->toArray()); // Convert PHP array to JavaScript array
