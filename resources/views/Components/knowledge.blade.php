...
<body>
    ...
    <div class="container">
        {{-- !------------------------NewBook-Content------------------------------ --}}
        <div class="newBook">
            <h2 data-aos="fade-right" data-aos-duration="500">ចំណេះដឹង</h2>
            <div class="bookList">
                <ul data-aos="fade-up" data-aos-duration="500" id="bookList">
                    <!-- Initially display the first 10 books -->
                    @foreach ($kbooks->take(10) as $index => $book)
                        <li class="book-item">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                let currentPage = 1;
                let booksAll = @json($kbooks->toArray()); // Convert PHP array to JavaScript array
